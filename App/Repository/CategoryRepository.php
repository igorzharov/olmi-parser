...
class CategoryRepository
{
    ...
    {
        $query = $this->db->query("SELECT category_id, GROUP_CONCAT(path_id ORDER BY path_id SEPARATOR ',') as 'path' FROM categories_path GROUP BY category_id");
    ...
    {
        $query = $this->db->query("SELECT category_id, GROUP_CONCAT(path_id ORDER BY path_id SEPARATOR ',') as 'path' FROM categories_path WHERE category_id = " . $categoryId);
